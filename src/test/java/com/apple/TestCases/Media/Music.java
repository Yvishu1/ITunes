...
public class Music extends TestDataProvider {
    ...
    @Test(dataProvider = "mediaTestData" ,groups = {"music"})
    public void testMoviesSearch(Map<String, String> testData) {
        ...
        Base.verifyAttributeValueExactMatchForMultipleObjects(response,resultCount,"kind","song");

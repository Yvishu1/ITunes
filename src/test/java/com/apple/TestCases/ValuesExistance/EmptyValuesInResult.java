...
public class EmptyValuesInResult extends TestDataProvider {
    ...
    public void testEmptyValuesInResult(Map<String, String> testData) {
        ...
        Base.verifyMatchedAttributeValueNotNull(response,resultCount,"");
